...
const EDUCATION = [
  {
    ...
    description:
      "Learning full-stack web development including HTML, CSS, JavaScript, React.js, Node.js, and integrating AI and cloud technologies.",
...
export default function Education() {
  return (
    <section
      id="education"
      style={{ borderTop: "1px solid var(--divider)", width: "100%" }}
    >
      <div className="section-wrap">
        ...
        {/* Certifications — scroll-margin-top offsets the fixed navbar height */}
        <div
          id="certifications"
          style={{
            scrollMarginTop: "90px", // matches navbar height so title is fully visible
          }}
        >
          <div
            style={{
              ...
              >
                ...
                >
                  {c.img ? (
                    ...
                    <span style={{ fontSize: "1.5rem", color: c.color }}>
                      {c.icon}
                    </span>
                  )}
                </div>
